...
class Informatika(models.Model):
    ...
    file = models.FileField('Archive', upload_to='upload/file/materials', null=True, blank=True)
    cover = models.ImageField('Cover', upload_to='upload/cover/materials', null=True, blank=True)
